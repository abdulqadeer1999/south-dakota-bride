                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="men" value="<?php echo e($edit_data->men); ?>" class="form-control btn-square" id="exampleFormControlInput10" type="text" placeholder="Groom">
                            </div>
                            <?php $__errorArgs = ['men'];
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="women" value="<?php echo e($edit_data->women); ?>" class="form-control btn-square" id="exampleFormControlInput10" type="text" placeholder="Bride">
                            </div>
                            <?php $__errorArgs = ['women'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="help-block" style="color: red">
                                <?php echo e($errors->first('women')); ?>
