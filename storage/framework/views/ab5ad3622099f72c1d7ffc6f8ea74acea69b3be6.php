                ...
                <div class="d-flex flex-row justify-content-around">
                    ...
                    <div class="Wed-Art-Div">
                        <div class="couple-img-wed">
                            <img src="<?php echo e(asset('website/images/1x/engagement-banner.png')); ?>" alt="">
                        </div>
    ...
    <div class="CstDivs container">
       <div class="row mt-5">
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('engagement-details')); ?>"><img src="<?php echo e(asset('website/images/1x/wed-img-1.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('engagement-details')); ?>"><img src="<?php echo e(asset('website/images/1x/wed-img-2.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
                        <h6 class="card-text">john Watson</h6>
                        <h6 class="card-text">And</h6>
                        <h6 class="card-text">Julie Williams</h6>
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('engagement-details')); ?>"><img src="<?php echo e(asset('website/images/1x/wed-img-3.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
                        <h6 class="card-text">john Watson</h6>
                        <h6 class="card-text">And</h6>
                        <h6 class="card-text">Julie Williams</h6>
