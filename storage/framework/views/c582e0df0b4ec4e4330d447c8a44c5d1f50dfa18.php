                ...
                <div class="d-flex flex-row justify-content-around">
                    ...
                    <div class="Wed-Art-Div">
                        <div class="couple-img-wed">
                            <img src="<?php echo e(asset('website/images/1x/event-banner.png')); ?>" alt="">
                        </div>
    ...
    <div class="CstDivs container">
       <div class="row mt-5">
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('event-details')); ?>"><img src="<?php echo e(asset('website/images/1x/event-img1.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('event-details')); ?>">
                    <img src="<?php echo e(asset('website/images/1x/event-img2.png')); ?>" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('event-details')); ?>">
                    <img src="<?php echo e(asset('website/images/1x/event-img3.png')); ?>" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="<?php echo e(route('event-details')); ?>">
                    <img src="<?php echo e(asset('website/images/1x/event-img1.png')); ?>" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                      <h6 class="card-text">wedding party</h6>
                    </div>
