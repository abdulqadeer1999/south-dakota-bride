    ...
    <div class="container CstDivs">
       <div class="row">
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <img src="<?php echo e(asset('website/images/1x/weds-1.png')); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <img src="<?php echo e(asset('website/images/1x/weds-2.png')); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <img src="<?php echo e(asset('website/images/1x/weds-3.png')); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <img src="<?php echo e(asset('website/images/1x/weds-4.png')); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-text">Photographer</h5>
                        <p class="weds-card-para-p">Devid Wastson</p>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <img src="<?php echo e(asset('website/images/1x/weds-6.png')); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="../pages/vendors-inner.html"><img src="<?php echo e(asset('website/images/1x/weds-7.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="../pages/vendors-inner.html"><img src="<?php echo e(asset('website/images/1x/weds-8.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animate__delay-1s animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="../pages/vendors-inner.html"><img src="<?php echo e(asset('website/images/1x/weds-9.png')); ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
