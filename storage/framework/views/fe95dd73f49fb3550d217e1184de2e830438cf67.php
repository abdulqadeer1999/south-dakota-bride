                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right">
                                <a type="button" class="btn btn-primary for-font-color" href="<?php echo e(route('termsCreate')); ?>">Create </a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <?php $__currentLoopData = $getCMS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success btn-xs for-font-color" type="button" data-original-title="btn btn-danger btn-xs" title=""> <a href="<?php echo e(route('termsEdit', $value->id)); ?>">Edit</a></button>
                                             </td>
                                        </tr>
