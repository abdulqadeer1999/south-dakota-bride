    ...
    <div class="for-content-tabs">
        ...
        {{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('message') }}
            ...
            <div class="row">
                ...
                <form action="{{ route('assesment_update',$edit_data->id) }}" enctype="multipart/form-data"
                    method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="login-content2 placeholder-white">
                                 ...
                                 <input name="audio" id="audio" class="form-control" value="{{ $edit_data->audio ??''}}"  type="file">
                            </div>
                            @error('audio')
                                <p class="help-block" style="color: red">
                                    {{ $errors->first('audio') }}
