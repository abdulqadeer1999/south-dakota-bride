                      ...
                      <div class="main-tabs-card">
                          <div class="tabs-card-content">
                            ...
                            array_push($id_arr,$value->id);
                             $rating_count++
                            @endphp
                            @foreach ($value->get_BookedEvaluator_rating as $items)
                            ...
                            @endforeach
                              ...
                              <div class="tabs-card-name">
                                  ...
                                  <div class="tabs-card-name">
                                    ...
                                    {{-- @if (!empty($value->get__booked_evaluator_rating_avg_rating_start))
                                    <div class="tabs-card-name">
                                        <div class="rricons">
                                            @php
                                                $conditioned_stars = ceil
                                                ($value->get__booked_evaluator_rating_avg_rating_start) > 5 ? 5 : ceil($value->get__booked_evaluator_rating_avg_rating_start);
                              ...
                              <div class="tabs-card-name">
                                  ...
                                  <a href="{{ route('Evaluators.profile',$value->id) }}" class="read-more-btn">Read More <i
