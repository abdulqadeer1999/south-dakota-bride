                    ...
                    <tbody>
                        ...
                        @foreach ($getAppoinment as $key => $value)
                            <tr>
                                ...
                                {{-- <td>{{ $value->title }}</td> --}}
                                <td>{{ $value->appoinment_date }}</td>
                                <td>{{ $value->appoinment_time }}</td>
                                {{-- <td>{{ $value->description }}</td> --}}
                                <td>
                                    <a class="btn btn-primary" type="button"
                                        href="{{ route('appoinment.edit', $value->id) }}">Edit</a>
                                        <a id="delete" class="btn btn-danger" type="button"
                                        href="{{ route('appoinment.destroy', $value->id) }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
