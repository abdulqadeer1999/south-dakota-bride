                                    ...
                                    @foreach ($getCMS as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success btn-xs for-font-color" type="button" data-original-title="btn btn-danger btn-xs" title=""> <a href="{{ route('privacyEdit', $value->id) }}">Edit</a></button>
                                             </td>
                                        </tr>
                                    @endforeach
                                </tbody>
