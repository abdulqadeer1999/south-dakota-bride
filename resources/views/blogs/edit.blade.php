                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="men" value="{{ $edit_data->men }}" class="form-control btn-square" id="exampleFormControlInput10" type="text" placeholder="Groom">
                            </div>
                            @error('men')
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="women" value="{{ $edit_data->women }}" class="form-control btn-square" id="exampleFormControlInput10" type="text" placeholder="Bride">
                            </div>
                            @error('women')
                            <p class="help-block" style="color: red">
                                {{ $errors->first('women') }}
