...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('website/images/SVG/logo.svg')}}" sizes="196x196" type="image/x-icon">
    <!-- Bootstrap 5 -->
    ...
    <header class="header" id="register-form">
        <div class="container">
            <nav class="destop-nav-bar">
                <div class="d-flex justify-content-around">
                    <div class="logo">
                        <a href="{{route('home')}}"> <img src="{{asset('website/images/SVG/white-logo.svg')}}" alt="img"></a>
                    </div>
                    <div class="link">
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="{{route('signin')}}" class="header_links text-white" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Sign In</a>
                            <a class="{{ Request::is('signup') ? 'active' : '' }}" href="{{route('signup')}}" class="header_links text-white" style="color: white"  >Sign Up</a>
        ...
        <div id="box" class="">
            <div id="items">
                ...
                <div class="item"><a href="{{route('signin')}}" class="header_links" data-bs-toggle="modal"
