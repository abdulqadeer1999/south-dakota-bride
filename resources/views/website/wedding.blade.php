                ...
                <div class="d-flex flex-row justify-content-around">
                    ...
                    <div class="Wed-Art-Div">
                        <div class="couple-img-wed">
                            <img src="{{asset('website/images/1x/banner-img-wed.png')}}" alt="">
                        </div>
    ...
    <div class="CstDivs container">
       <div class="row mt-5">
            <div class="col-lg-4 col-sm-6 mt-4 wow animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                   <a href="{{route('wedding-details')}}"> <img src="{{asset('website/images/1x/wed-img-1.png')}}" class="card-img-top" alt="..."></a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="{{route('wedding-details')}}"><img src="{{asset('website/images/1x/wed-img-2.png')}}" class="card-img-top" alt="..."></a>
                    <div class="card-body">
                        <h6 class="card-text">john Watson</h6>
                        <h6 class="card-text">And</h6>
                        <h6 class="card-text">Julie Williams</h6>
            ...
            <div class="col-lg-4 col-sm-6 mt-4 wow animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="card">
                    <a href="{{route('wedding-details')}}"> <img src="{{asset('website/images/1x/wed-img-3.png')}}" class="card-img-top" alt="..."></a>
                    <div class="card-body">
                        <h6 class="card-text">john Watson</h6>
                        <h6 class="card-text">And</h6>
                        <h6 class="card-text">Julie Williams</h6>
