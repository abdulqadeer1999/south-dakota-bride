            ...
            <div class="col-lg-6 col-md-6 col-sm-12 overlay-image-text wow animated fadeInLeft"
                ...
                <div class="d-flex flex-row justify-content-around">
                    ...
                    <div class="Wed-Art-Div">
                        ...
                        <div class="couple-img ">
                            <img src="{{asset('website//images/1x/couple-image.png')}}" alt="">
                        </div>
                ...
                <div class="col-lg-5 col-sm-12 ">
                    <div class="about-text-div">
                        ...
                        <div class="overlay-image pt-5">
                            <img src="{{asset('website/images/1x/about-overlay.png')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="about-bg wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="{{asset('website/images/1x/about-bg_1.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="col-lg-3 col-sm-6 mb-5">
                        <div>
                            <div class="wrapper">
                                <div class="navi">
                                    <img src="{{asset('website/images/1x/img1.png')}}">
                                </div>
                                <div id="infoi">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                    ...
                    <div class="col-lg-3 col-sm-6  mb-5">
                        <div>
                            <div class="wrapper1">
                                <div class="navi1">
                                    <img src="{{asset('website/images/1x/img2.png')}}">
                                </div>
                                <div id="infoi1">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                    ...
                    <div class="col-lg-3 col-sm-6  mb-5">
                        <div>
                            <div class="wrapper">
                                <div class="navi">
                                    <img src="{{asset('website/images/1x/img3.png')}}">
                                </div>
                                <div id="infoi">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                    ...
                    <div class="col-lg-3 col-sm-6  mb-5">
                        <div>
                            <div class="wrapper1">
                                <div class="navi1">
                                    <img src="{{asset('website/images/1x/img4.png')}}">
                                </div>
                                <div id="infoi1">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                ...
                <div class="row wow animated fadeInRight">
                    <div class="col-lg-3 col-sm-6 mb-5">
                        <div>
                            <div class="wrapper">
                                <div class="navi">
                                    <img src="{{asset('website/images/1x/img5.png')}}">
                                </div>
                                <div id="infoi">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                    ...
                    <div class="col-lg-3 col-sm-6  mb-5">
                        <div>
                            <div class="wrapper1">
                                <div class="navi1">
                                    <img src="{{asset('website/images/1x/img6.png')}}">
                                </div>
                                <div id="infoi1">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                    ...
                    <div class="col-lg-3 col-sm-6  mb-5">
                        <div>
                            <div class="wrapper">
                                <div class="navi">
                                    <img src="{{asset('website/images/1x/img7.png')}}">
                                </div>
                                <div id="infoi">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
                    ...
                    <div class="col-lg-3 col-sm-6  mb-5">
                        <div>
                            <div class="wrapper1">
                                <div class="navi1">
                                    <img src="{{asset('website/images/1x/img8.png')}}">
                                </div>
                                <div id="infoi1">
                                    <div class="fixed">
                                        <h6>Lorem ipsum</h6>
